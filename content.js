var content = {
  ...
  case1_title: "回収から再資源化までの経路を設計する",
  case1_text: "排出される場所と量を現場で確認し、分別の手順、一時保管、引き渡し先までを一続きで設計します。古紙再生メーカーなどの受け入れ先と条件をすり合わせ、再生品として戻るところまでを確かめてから運用に移します。",
  case2_title: "大学・学生を巻き込んで体制をつくる",
  case2_text: "企業から提示された課題を学生チームが引き受け、調査・提案から成果報告までを伴走します。社外の視点と手を入れることで、担当者だけに負担が集中しない進め方をつくります。",
